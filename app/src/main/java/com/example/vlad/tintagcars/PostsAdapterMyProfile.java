...
public class PostsAdapterMyProfile extends BaseAdapter {
    ...
    public PostsAdapterMyProfile(Activity activity, ArrayList<PostS> list) {
        postsList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            vi = inflater.inflate(R.layout.post_profile, null);

        phoneButton = (Button)vi.findViewById(R.id.phonePreviewPosts);
        phoneButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:"+phoneButton.getText().toString()));//opens a phone call intent and lets the user call the post number
                context.startActivity(intent);
            }
        });
            deletePost = (Button) vi.findViewById(R.id.deletePostPreviewPosts);
        final PostS finalPost = post;
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                service.enqueue(new Callback<ResponseBody>() {
                                    ...
                                    public void onResponse(Call<ResponseBody> service, Response<ResponseBody> response) {
                                        ...
                                        CharSequence text = "Post deleted with success!";
                                    ...
                                    public void onFailure(Call<ResponseBody> call, Throwable t) {
                                        ...
                                        CharSequence text = "Failed to delete post!";
                                        int duration = Toast.LENGTH_SHORT;
        ...
        TextView t1textCarType = (TextView) vi.findViewById(R.id.textCarTypePreviewPosts);
        TextView t2textCarDetails = (TextView) vi.findViewById(R.id.textCarDetailsPreviewPosts);
        TextView t3companyName = (TextView) vi.findViewById(R.id.companyNamePreviewPosts);
        TextView t4locationText = (TextView) vi.findViewById(R.id.locationTextPreviewPosts);
        TextView t5phone = (TextView) vi.findViewById(R.id.phonePreviewPosts);
        TextView t6price = (TextView) vi.findViewById(R.id.pricePreviewPosts);
        TextView t7discount = (TextView) vi.findViewById(R.id.discountPreviewPosts);
        TextView t8totalPrice = (TextView) vi.findViewById(R.id.totalPricePreviewPosts);



        editComment = (ImageView) vi.findViewById(R.id.editCommentPreviewPosts);
        ...
        ImageView image = (ImageView) vi.findViewById(R.id.imagePostPreviewPosts);


        Glide.with(context)//Had to set syze dynamicaly because for some reason some of the post
                //images got shrinked
    ...
    public void add(PostS object, Context context, Retrofit retrofit) {
