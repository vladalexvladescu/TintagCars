...
public class MoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more);//sets the view from the layout in the activity
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:{
                        ...
                        if(menuId== R.id.sell_car_image_button){
                            Intent pIntent = new Intent(MoreActivity.this, SellMyCarActivity.class);
                        ...
                        if(menuId== R.id.profile_image_button){
                            Intent pIntent = new Intent(MoreActivity.this, MyProfileActivity.class);
                            // Bundle pBundle = new Bundle();
                            //pIntent.putExtra("users","MERGE");
                            finish();
                            startActivity(pIntent);
                        ...
                        if(menuId== R.id.services_image_button){
                            Intent pIntent = new Intent(MoreActivity.this, ServicesActivity.class);
                            //Bundle pBundle = new Bundle();
                            //pIntent.putExtra("users","MERGE");
                            finish();
                            startActivity(pIntent);
                        ...
                        if(menuId== R.id.more_image_button){
                            Intent pIntent = new Intent(MoreActivity.this, MoreActivity.class);
                            // Bundle pBundle = new Bundle();
                            //pIntent.putExtra("users","MERGE");
                            finish();
                            startActivity(pIntent);
