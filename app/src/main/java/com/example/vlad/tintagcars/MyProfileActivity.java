...
public class MyProfileActivity extends AppCompatActivity {
    ...
    public static PostsAdapterMyProfile postsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_profile);//sets the view from the layout in the activity
        getSupportActionBar().hide();
        ((App) getApplication()).getNetComponent().inject(this);

        context=this;
        inputSearch = (EditText) findViewById(R.id.inputSearchPreviewPosts);
        inputSearch.setVisibility(View.INVISIBLE);
        terms = (TextView) findViewById(R.id.termsPreviewPosts);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    for(PostS index:serverArrayUsers){
                        ...
                        //thats how we know that the elements are posts from this aplication

                        postsArray.add(index);
                            Log.i("arrayUsersProfile","index: " +index.getUserFirstName());
                        postsAdapter.add(index,context,retrofit);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:{
                        if(menuId== R.id.search_car_image_buttonPreviewPosts){
                                ...
                                public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                                    ...
                                    if(postsArrayAfterSearch.size()!=0){
                                        ...
                                        for(PostS p :postsArrayAfterSearch){
                                            postsAdapter.add(p,context, retrofit);
                                            postsAdapter.notifyDataSetChanged();
                        ...
                        if(menuId== R.id.sell_car_image_buttonPreviewPosts){
                            Intent pIntent = new Intent(MyProfileActivity.this, SellMyCarActivity.class);
                            //Bundle pBundle = new Bundle();
                            //pIntent.putExtra("users","MERGE");
                            startActivity(pIntent);
                        }
                        if(menuId== R.id.profile_image_buttonPreviewPosts){
                            Intent pIntent = new Intent(MyProfileActivity.this, MyProfileActivity.class);
                            // Bundle pBundle = new Bundle();
                            //pIntent.putExtra("users","MERGE");
                            startActivity(pIntent);
                        }
                        if(menuId== R.id.services_image_buttonPreviewPosts){
                            Intent pIntent = new Intent(MyProfileActivity.this, ServicesActivity.class);
                            //Bundle pBundle = new Bundle();
                            //pIntent.putExtra("users","MERGE");
                            startActivity(pIntent);
                        }
                        if(menuId== R.id.more_image_buttonPreviewPosts){
                            Intent pIntent = new Intent(MyProfileActivity.this, MoreActivity.class);
                            // Bundle pBundle = new Bundle();
                            //pIntent.putExtra("users","MERGE");
                            startActivity(pIntent);
                        }
        ...
        search = (ImageView) findViewById(R.id.search_car_image_buttonPreviewPosts);
        search.setOnTouchListener(listener);
        sellCar = (ImageView) findViewById(R.id.sell_car_image_buttonPreviewPosts);
        sellCar.setOnTouchListener(listener);
        myProfile = (ImageView) findViewById(R.id.profile_image_buttonPreviewPosts);
        myProfile.setOnTouchListener(listener);
        services = (ImageView) findViewById(R.id.services_image_buttonPreviewPosts);
        services.setOnTouchListener(listener);
        more = (ImageView) findViewById(R.id.more_image_buttonPreviewPosts);
        more.setOnTouchListener(listener);



        postsListView = (ListView) findViewById(R.id.posts_area_editPreviewPosts);//sets the listView of post from the layout
        ...
        postsAdapter = new PostsAdapterMyProfile(this, postsArray);
        postsListView.setAdapter(postsAdapter);
